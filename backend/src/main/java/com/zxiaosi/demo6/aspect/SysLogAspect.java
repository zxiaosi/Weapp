package com.zxiaosi.demo6.aspect;

import com.alibaba.fastjson2.JSON;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.zxiaosi.demo6.common.utils.IpUtils;
import com.zxiaosi.demo6.domain.vo.SysLogVo;
...
public class SysLogAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.zxiaosi.demo6.controller.*.*(..))")
    public void sysLog() {
    }
